...
const Skin1  = (props) => {
    ...
    return ( 
        ...
        <React.Fragment>
            ...
            <div className="contact-full-name">{fname} {lname}</div>
            <div className="email-phone">
            <div className="email-details">{emailpd}</div>
            <div className="phone-details">{phone}</div>
            </div>
            <div className="address-details">{street} {city} {pin} {state} {country}</div>
            ...
            <div className="education-details-degree">{degree} with GPA : {cgpa}</div>
            <div className="education-details-name">{collegeName} , {educationCity} , {educationState}  {graduationMonth} {graduationYear}</div>
            </div>
            </div>
